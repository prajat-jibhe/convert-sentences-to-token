...
# Step 1: Load the full list of Spanish abusive words from GitHub
def load_spanish_abusive_words():
    # URL to the raw list of Spanish profanity from GitHub
...
def convert_text_csv_with_synthetic(text_csv_path, output_csv_path=None, num_synthetic_rows=1000):
    abusive_words_list = load_spanish_abusive_words()
...
if __name__ == "__main__":
    text_csv_path = "Spanish.csv"  # Path to your text + label CSV
    output_csv_path = "combined_spanish_with_synthetic.csv"  # Output path
